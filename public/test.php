...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($_POST['regenerate_keys'])) {
        ...
        try {
            ...
            switch ($selectedApi) {
                case 'generate_otp':
                    $plainRequest = ['countryCode' => $_POST['country_code'] ?? '91', 'mobileNumber' => $_POST['mobile_number_otp'] ?? ''];
                ...
                default:
                    $plainRequest = ["mobileNumber" => $_POST['mobile_number_sv'] ?? DEFAULT_MOBILE_NUMBER, "additionalDetails" => $_POST['additional_details'] ?? DEFAULT_ADDITIONAL_DETAILS];
                ...
                <form method="POST" action="" id="apiForm">
                    ...
                    <div class="api-fields" id="fields_silent_verification">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="mobile_number_sv" id="sv_mobile" value="<?php echo htmlspecialchars($_POST['mobile_number_sv'] ?? ''); ?>" placeholder="Enter 10-digit mobile number">
                        </div>
                        <div class="form-group">
                    ...
                    <div class="api-fields" id="fields_generate_otp">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group">
                                <label>📱 Mobile Number <span style="color:#e53e3e">*</span></label>
                                <input type="text" name="mobile_number_otp" value="<?php echo htmlspecialchars($_POST['mobile_number_otp'] ?? ''); ?>" placeholder="Enter 10-digit mobile number">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="api-fields" id="fields_geo_fencing">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group" style="max-width:140px">
                                ...
                                <input type="text" name="geo_state" value="<?php echo htmlspecialchars($_POST['geo_state'] ?? ''); ?>" placeholder="MH">
                            </div>
                        </div>
                    </div>
