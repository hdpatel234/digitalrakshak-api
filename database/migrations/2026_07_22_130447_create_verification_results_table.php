...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('verification_results', function (Blueprint $table) {
            ...
            $table->unsignedBigInteger('candidate_service_data_id')->index('idx_verification_results_candidate');
            $table->enum('verification_status', ['pending', 'in_progress', 'verified', 'failed', 'error'])->default('pending');
            $table->decimal('verification_score', 5)->nullable()->comment('Confidence score 0-100');
            ...
            $table->enum('verification_method', ['auto', 'manual', 'hybrid'])->nullable()->default('auto');
