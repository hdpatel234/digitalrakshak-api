...
CREATE TABLE IF NOT EXISTS `tblpayment_method_types` (
  `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT,
  `method_name` varchar(100) NOT NULL,
  `method_code` varchar(50) UNIQUE NOT NULL,
  `category` enum('card','upi','netbanking','wallet','bank','cash','other') NOT NULL,
...
CREATE TABLE IF NOT EXISTS `tblpayment_gateways` (
  `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT,
  `gateway_name` varchar(255) NOT NULL,
  `gateway_code` varchar(100) UNIQUE NOT NULL,
  `provider_company` varchar(255) DEFAULT NULL,
  `website` varchar(500) DEFAULT NULL,
  `description` text DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `tblpayment_gateway_configs` (
  `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT,
  ...
  `settlement_cycle` enum('instant','daily','t+1','t+2','weekly','monthly') DEFAULT 't+1',
  `settlement_bank` varchar(255) DEFAULT NULL,
  ...
  `health_status` enum('healthy','unhealthy','degraded') DEFAULT 'healthy',
  `error_count` int(11) DEFAULT 0,  
  `created_by` bigint(20) UNSIGNED DEFAULT NULL,
  `updated_by` bigint(20) UNSIGNED DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT current_timestamp(),
  ...
  `deleted_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `payment_gateway_configs_env` (`gateway_id`, `environment`, `is_active`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

CREATE TABLE IF NOT EXISTS `tblclient_payment_gateways` (
  `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT,
  `client_id` bigint(20) UNSIGNED NOT NULL,
  `gateway_config_id` bigint(20) UNSIGNED NOT NULL,
  `display_name` varchar(255) DEFAULT NULL,
  `display_order` int(11) DEFAULT 0,
  `enabled_methods` json DEFAULT NULL,
  `currencies` json DEFAULT NULL,
  `fee_type` enum('global','fixed','percentage','both') DEFAULT 'global',
  ...
  `deleted_at` timestamp NULL DEFAULT NULL,  
  PRIMARY KEY (`id`),
  UNIQUE KEY `unique_client_gateway` (`client_id`, `gateway_config_id`),
  KEY `client_payment_gateways_enabled` (`client_id`, `is_enabled`, `display_order`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

CREATE TABLE IF NOT EXISTS `tblclient_payment_methods` (
  `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT,
  `client_id` bigint(20) UNSIGNED NOT NULL,
  `method_type_id` bigint(20) UNSIGNED NOT NULL,
  `gateway_config_id` bigint(20) UNSIGNED DEFAULT NULL,  
  `display_name` varchar(255) DEFAULT NULL,
  `description` text DEFAULT NULL,
  ...
  `updated_at` timestamp NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  PRIMARY KEY (`id`),
  UNIQUE KEY `unique_client_method` (`client_id`, `method_type_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

CREATE TABLE IF NOT EXISTS `tblclient_bank_accounts` (
  `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT,
  `client_id` bigint(20) UNSIGNED NOT NULL,
  `account_name` varchar(255) NOT NULL,
  `bank_name` varchar(255) NOT NULL,
  `account_number` varchar(100) NOT NULL,
  `account_type` enum('savings','current','cash_credit') DEFAULT 'current',
  ...
  `deleted_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `client_bank_accounts_primary` (`client_id`, `is_primary`, `is_active`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE IF NOT EXISTS `tblpayment_transactions` (
  ...
  `invoice_id` bigint(20) UNSIGNED DEFAULT NULL,
  `gateway_config_id` bigint(20) UNSIGNED DEFAULT NULL,
  `client_gateway_id` bigint(20) UNSIGNED DEFAULT NULL,
  `method_type_id` bigint(20) UNSIGNED DEFAULT NULL,  
  `amount` decimal(10,2) NOT NULL,
  `currency` varchar(3) DEFAULT 'INR',
  `tax_amount` decimal(10,2) DEFAULT 0.00,
  ...
  `status` enum('initiated','pending','authorized','captured','success','failed','refunded','partially_refunded','cancelled') DEFAULT 'initiated',
  `payment_status` enum('pending','paid','failed','refunded') DEFAULT 'pending',
  ...
  `gateway_webhook` json DEFAULT NULL,
  ...
  `deleted_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),  
  KEY `payment_transactions_status` (`status`, `payment_status`),
  KEY `payment_transactions_gateway` (`gateway_transaction_id`),
  KEY `payment_transactions_customer` (`customer_email`),
  KEY `payment_transactions_created` (`created_at`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

CREATE TABLE IF NOT EXISTS `tblpayment_refunds` (
  `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT,
  `transaction_id` bigint(20) UNSIGNED NOT NULL,
  `refund_uuid` varchar(100) UNIQUE NOT NULL,
...
CREATE TABLE IF NOT EXISTS `tblsaved_payment_methods` (
  `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT,
  `client_id` bigint(20) UNSIGNED NOT NULL,
  `user_id` bigint(20) UNSIGNED DEFAULT NULL,
  ...
  `display_name` varchar(255) DEFAULT NULL,
  `masked_details` varchar(255) DEFAULT NULL,
